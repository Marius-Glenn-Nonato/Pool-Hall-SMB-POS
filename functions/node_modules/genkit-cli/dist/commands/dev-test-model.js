...
exports.devTestModel = new commander_1.Command('dev:test-model')
    ...
    .option('--supports <list>', 'Comma-separated list of supported capabilities (tool-request, structured-output, multiturn, system-role, input-image-base64, input-image-url, input-video-youtube, output-audio, output-image)', 'tool-request,structured-output,multiturn,system-role,input-image-base64,input-image-url')
    ...
    if (cmd.length > 0) {
        ...
        manager = await (0, manager_utils_1.startManager)(projectRoot, false);
    }
